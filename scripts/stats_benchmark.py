...
class memoryUsage():
    ...
    __TEMPLATE__ = {'obj':object, 'val':np.uint64} # As { getattr(parent/class, '_parent/classOBJECT').copy(), ram_usage }
    def __init__(self):
...
if __name__ == "__main__":
    print("\n".join([f"{type(i['obj']).__name__}: {i['val']}" for i in memoryUsage()._OBJECTS]))
